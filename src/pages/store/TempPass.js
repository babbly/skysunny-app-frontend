...
export default function TempPass({ navigation }) {
                ...
                <View style={layout.topBar}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={layout.topText}>정기권 구매</Text>
                        </View>
                    </View>
                </View>
                        ...
                        <View style={{ alignItems: 'center', paddingVertical: scaleHeight(15) }}>
                            <TouchableOpacity onPress={() => setSelectedType('cash')}>
                                <ImageBackground
                                    ...
                                    resizeMode="contain"
                                >
                                    <Text style={[styles.title, { color: selectedType === 'cash' ? color.blackGray : '#5e6165', }]}>캐시정기권</Text>
                                    <Text style={[styles.text1, { color: selectedType === 'cash' ? color.blackGray : '#5e6165', }]}>전국 스카스카 가맹점에서 사용하실 수 있습니다.</Text>
                                    <Text style={[styles.text2, { color: selectedType === 'cash' ? color.blackGray : '#5e6165', }]}>- 이용권 설명란</Text>
                            ...
                            <View style={{ marginTop: scaleHeight(10) }}>
                                <TouchableOpacity onPress={() => setSelectedType('free')}>
                                    ...
                                    >
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            <Text style={[styles.title, { color: selectedType === 'free' ? color.blackGray : '#5e6165', marginRight: scaleWidth(5) }]}>기간정기권</Text>
                                            <Text style={{
                                                borderLeftWidth: 1, borderLeftColor: '#5e6165', height: scaleHeight(16),
                                                textAlign: 'center', paddingLeft: scaleWidth(5)
                                            }}>자유석</Text>
                                        </View>
                                        <Text style={[styles.text1, { color: selectedType === 'free' ? color.blackGray : '#5e6165', }]}>결제한 가맹점에서만 사용하실 수 있습니다.</Text>
                                        <Text style={[styles.text2, { color: selectedType === 'free' ? color.blackGray : '#5e6165', }]}>- 이용권 설명란</Text>
                            ...
                            <View style={{ marginTop: scaleHeight(10) }}>
                                <TouchableOpacity onPress={() => setSelectedType('fix')}>
                                    ...
                                    >
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            <Text style={[styles.title, { color: selectedType === 'fix' ? color.blackGray : '#5e6165', marginRight: scaleWidth(5) }]}>기간정기권</Text>
                                            <Text style={{
                                                borderLeftWidth: 1, borderLeftColor: '#5e6165', height: scaleHeight(16),
                                                textAlign: 'center', paddingLeft: scaleWidth(5)
                                            }}>고정석</Text>
                                        </View>
                                        <Text style={[styles.text1, { color: selectedType === 'fix' ? color.blackGray : '#5e6165', }]}>해당 매장의 지정된 좌석만 에약이 가능합니다.</Text>
                                        <Text style={[styles.text2, { color: selectedType === 'fix' ? color.blackGray : '#5e6165', }]}>- 이용권 설명란</Text>
